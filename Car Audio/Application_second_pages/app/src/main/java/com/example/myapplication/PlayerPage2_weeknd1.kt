...
class PlayerPage2_weeknd1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_player_page2_weeknd1)
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.weeknd_gasoline)
        ...
        override fun onFling(
            ...
            try {
                ...
                if (abs(diffX) > abs(diffY) &&
                    ...
                    stopMusic()
                    startActivity(Intent(this@PlayerPage2_weeknd1, PlayerPage2_weeknd_2::class.java))
                    return true
                }
