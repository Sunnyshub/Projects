...
class PlayerPage_noight_tempo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_player_page_noight_tempo)
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.wine_night)
        ...
        override fun onFling(
            ...
            try {
                ...
                if (abs(diffX) > abs(diffY) &&
                    ...
                    startActivity(Intent(this@PlayerPage_noight_tempo, PlayerPage::class.java))
                    return true
                }
